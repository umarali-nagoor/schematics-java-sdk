...
/**
 * Unit test class for the CreateSharedDatasetOptions model.
 */
public class CreateSharedDatasetOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testCreateSharedDatasetOptions() throws Throwable {
    ...
    CreateSharedDatasetOptions createSharedDatasetOptionsModel = new CreateSharedDatasetOptions.Builder()
      ...
      .version("testString")
      .build();
    assertEquals(createSharedDatasetOptionsModel.autoPropagateChange(), Boolean.valueOf(true));
    assertEquals(createSharedDatasetOptionsModel.description(), "testString");
    assertEquals(createSharedDatasetOptionsModel.effectedWorkspaceIds(), new java.util.ArrayList<String>(java.util.Arrays.asList("testString")));
    assertEquals(createSharedDatasetOptionsModel.resourceGroup(), "testString");
    assertEquals(createSharedDatasetOptionsModel.sharedDatasetData(), new java.util.ArrayList<SharedDatasetData>(java.util.Arrays.asList(sharedDatasetDataModel)));
    assertEquals(createSharedDatasetOptionsModel.sharedDatasetName(), "testString");
    assertEquals(createSharedDatasetOptionsModel.sharedDatasetSourceName(), "testString");
    assertEquals(createSharedDatasetOptionsModel.sharedDatasetType(), new java.util.ArrayList<String>(java.util.Arrays.asList("testString")));
    assertEquals(createSharedDatasetOptionsModel.tags(), new java.util.ArrayList<String>(java.util.Arrays.asList("testString")));
    assertEquals(createSharedDatasetOptionsModel.version(), "testString");
  }
}