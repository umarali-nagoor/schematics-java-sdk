...
/**
 * Unit test class for the CreateBlueprintOptions model.
 */
public class CreateBlueprintOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testCreateBlueprintOptions() throws Throwable {
    ...
    CreateBlueprintOptions createBlueprintOptionsModel = new CreateBlueprintOptions.Builder()
      ...
      .build();
    assertEquals(createBlueprintOptionsModel.name(), "Toronto Dev Environtment");
    assertEquals(createBlueprintOptionsModel.schemaVersion(), "1.0");
    assertEquals(createBlueprintOptionsModel.source(), externalSourceModel);
    assertEquals(createBlueprintOptionsModel.config(), java.util.Arrays.asList(blueprintConfigItemModel));
    assertEquals(createBlueprintOptionsModel.description(), "Deploys dev environtment instance in Toronto Region");
    assertEquals(createBlueprintOptionsModel.resourceGroup(), "Default");
    assertEquals(createBlueprintOptionsModel.tags(), java.util.Arrays.asList("blueprint:Tor-Dev"));
    assertEquals(createBlueprintOptionsModel.location(), "us-south");
    assertEquals(createBlueprintOptionsModel.inputs(), java.util.Arrays.asList(variableDataModel));
    assertEquals(createBlueprintOptionsModel.settings(), java.util.Arrays.asList(variableDataModel));
    assertEquals(createBlueprintOptionsModel.flow(), blueprintFlowModel);
    assertEquals(createBlueprintOptionsModel.userState(), userStateModel);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testCreateBlueprintOptionsError() throws Throwable {
    new CreateBlueprintOptions.Builder().build();
  }
