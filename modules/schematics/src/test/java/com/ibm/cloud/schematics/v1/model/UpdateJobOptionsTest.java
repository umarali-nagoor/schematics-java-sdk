...
public class UpdateJobOptionsTest {
  ...
  public void testUpdateJobOptions() throws Throwable {
    ...
    assertEquals(updateJobOptionsModel.commandOptions(), new java.util.ArrayList<String>(java.util.Arrays.asList("testString")));
    assertEquals(updateJobOptionsModel.inputs(), new java.util.ArrayList<VariableData>(java.util.Arrays.asList(variableDataModel)));
    assertEquals(updateJobOptionsModel.settings(), new java.util.ArrayList<VariableData>(java.util.Arrays.asList(variableDataModel)));
    assertEquals(updateJobOptionsModel.tags(), new java.util.ArrayList<String>(java.util.Arrays.asList("testString")));
