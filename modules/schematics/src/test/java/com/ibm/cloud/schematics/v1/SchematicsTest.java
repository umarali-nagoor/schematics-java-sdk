...
import com.ibm.cloud.schematics.v1.model.BlueprintLite;
...
import com.ibm.cloud.schematics.v1.model.CatalogSourceLite;
...
import com.ibm.cloud.schematics.v1.model.ExternalSourceLite;
...
import com.ibm.cloud.schematics.v1.model.GitSourceLite;
...
public class SchematicsTest {
  ...
  public void testListBlueprintWOptions() throws Throwable {
    ...
    ListBlueprintOptions listBlueprintOptionsModel = new ListBlueprintOptions.Builder()
      .offset(Long.valueOf("0"))
      .limit(Long.valueOf("100"))
      .build();

    // Invoke listBlueprint() with a valid options model and verify the result
    Response<BlueprintList> response = schematicsService.listBlueprint(listBlueprintOptionsModel).execute();
    assertNotNull(response);
    BlueprintList responseObj = response.getResult();
    assertNotNull(responseObj);
    ...
    // Verify request path
    String parsedPath = TestUtilities.parseReqPath(request);
    assertEquals(parsedPath, listBlueprintPath);
    // Verify query params
    Map<String, String> query = TestUtilities.parseQueryString(request);
    assertNotNull(query);
    assertEquals(Long.valueOf(query.get("offset")), Long.valueOf("0"));
  ...
  // Test the listBlueprint operation with and without retries enabled
  @Test
  public void testListBlueprintWRetries() throws Throwable {
    schematicsService.enableRetries(4, 30);
    testListBlueprintWOptions();

    schematicsService.disableRetries();
    testListBlueprintWOptions();
  }

  // Test the createBlueprint operation with a valid options model parameter
  @Test
  public void testCreateBlueprintWOptions() throws Throwable {
    // Register a mock response
    ...
    String createBlueprintPath = "/v2/blueprints";
    server.enqueue(new MockResponse()
      .setHeader("Content-type", "application/json")
      .setResponseCode(200)
      .setBody(mockResponseBody));
    ...
    CreateBlueprintOptions createBlueprintOptionsModel = new CreateBlueprintOptions.Builder()
    ...
    // Invoke createBlueprint() with a valid options model and verify the result
    Response<Blueprint> response = schematicsService.createBlueprint(createBlueprintOptionsModel).execute();
    assertNotNull(response);
    Blueprint responseObj = response.getResult();
    assertNotNull(responseObj);
    ...
    // Verify request path
    String parsedPath = TestUtilities.parseReqPath(request);
    assertEquals(parsedPath, createBlueprintPath);
    // Verify that there is no query string
    Map<String, String> query = TestUtilities.parseQueryString(request);
    assertNull(query);
  }

  // Test the createBlueprint operation with and without retries enabled
  @Test
  public void testCreateBlueprintWRetries() throws Throwable {
    schematicsService.enableRetries(4, 30);
    testCreateBlueprintWOptions();

    schematicsService.disableRetries();
    testCreateBlueprintWOptions();
  }

  // Test the createBlueprint operation with a null options model (negative test)
  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testCreateBlueprintNoOptions() throws Throwable {
    server.enqueue(new MockResponse());
    schematicsService.createBlueprint(null).execute();
  }

  // Test the getBlueprint operation with a valid options model parameter
  @Test
  public void testGetBlueprintWOptions() throws Throwable {
    // Register a mock response
    String mockResponseBody = "{\"name\": \"Toronto Dev Environtment\", \"schema_version\": \"1.0\", \"source\": {\"source_type\": \"local\", \"git\": {\"computed_git_repo_url\": \"computedGitRepoUrl\", \"git_repo_url\": \"gitRepoUrl\", \"git_token\": \"gitToken\", \"git_repo_folder\": \"gitRepoFolder\", \"git_release\": \"gitRelease\", \"git_branch\": \"gitBranch\", \"git_commit\": \"gitCommit\", \"git_commit_timestamp\": \"gitCommitTimestamp\"}, \"catalog\": {\"catalog_name\": \"catalogName\", \"catalog_id\": \"catalogId\", \"offering_name\": \"offeringName\", \"offering_version\": \"offeringVersion\", \"offering_kind\": \"offeringKind\", \"offering_target_kind\": \"offeringTargetKind\", \"offering_id\": \"offeringId\", \"offering_version_id\": \"offeringVersionId\", \"offering_version_flavour_name\": \"offeringVersionFlavourName\", \"offering_repo_url\": \"offeringRepoUrl\", \"offering_provisioner_working_directory\": \"offeringProvisionerWorkingDirectory\", \"dry_run\": true, \"owning_account\": \"owningAccount\", \"item_icon_url\": \"itemIconUrl\", \"item_id\": \"itemId\", \"item_name\": \"itemName\", \"item_readme_url\": \"itemReadmeUrl\", \"item_url\": \"itemUrl\", \"launch_url\": \"launchUrl\"}}, \"config\": [{\"name\": \"name\", \"description\": \"description\", \"source\": {\"source_type\": \"local\", \"git\": {\"computed_git_repo_url\": \"computedGitRepoUrl\", \"git_repo_url\": \"gitRepoUrl\", \"git_token\": \"gitToken\", \"git_repo_folder\": \"gitRepoFolder\", \"git_release\": \"gitRelease\", \"git_branch\": \"gitBranch\", \"git_commit\": \"gitCommit\", \"git_commit_timestamp\": \"gitCommitTimestamp\"}, \"catalog\": {\"catalog_name\": \"catalogName\", \"catalog_id\": \"catalogId\", \"offering_name\": \"offeringName\", \"offering_version\": \"offeringVersion\", \"offering_kind\": \"offeringKind\", \"offering_target_kind\": \"offeringTargetKind\", \"offering_id\": \"offeringId\", \"offering_version_id\": \"offeringVersionId\", \"offering_version_flavour_name\": \"offeringVersionFlavourName\", \"offering_repo_url\": \"offeringRepoUrl\", \"offering_provisioner_working_directory\": \"offeringProvisionerWorkingDirectory\", \"dry_run\": true, \"owning_account\": \"owningAccount\", \"item_icon_url\": \"itemIconUrl\", \"item_id\": \"itemId\", \"item_name\": \"itemName\", \"item_readme_url\": \"itemReadmeUrl\", \"item_url\": \"itemUrl\", \"launch_url\": \"launchUrl\"}}, \"inputs\": [{\"name\": \"name\", \"value\": \"value\", \"use_default\": true, \"metadata\": {\"type\": \"boolean\", \"aliases\": [\"aliases\"], \"description\": \"description\", \"cloud_data_type\": \"cloudDataType\", \"default_value\": \"defaultValue\", \"link_status\": \"normal\", \"secure\": true, \"immutable\": false, \"hidden\": true, \"required\": true, \"options\": [\"options\"], \"min_value\": 8, \"max_value\": 8, \"min_length\": 9, \"max_length\": 9, \"matches\": \"matches\", \"position\": 8, \"group_by\": \"groupBy\", \"source\": \"source\"}, \"link\": \"link\"}]}], \"description\": \"Deploys dev environtment instance in Toronto Region\", \"resource_group\": \"Default\", \"tags\": [\"tags\"], \"location\": \"us-south\", \"inputs\": [{\"name\": \"name\", \"value\": \"value\", \"use_default\": true, \"metadata\": {\"type\": \"boolean\", \"aliases\": [\"aliases\"], \"description\": \"description\", \"cloud_data_type\": \"cloudDataType\", \"default_value\": \"defaultValue\", \"link_status\": \"normal\", \"secure\": true, \"immutable\": false, \"hidden\": true, \"required\": true, \"options\": [\"options\"], \"min_value\": 8, \"max_value\": 8, \"min_length\": 9, \"max_length\": 9, \"matches\": \"matches\", \"position\": 8, \"group_by\": \"groupBy\", \"source\": \"source\"}, \"link\": \"link\"}], \"settings\": [{\"name\": \"name\", \"value\": \"value\", \"use_default\": true, \"metadata\": {\"type\": \"boolean\", \"aliases\": [\"aliases\"], \"description\": \"description\", \"cloud_data_type\": \"cloudDataType\", \"default_value\": \"defaultValue\", \"link_status\": \"normal\", \"secure\": true, \"immutable\": false, \"hidden\": true, \"required\": true, \"options\": [\"options\"], \"min_value\": 8, \"max_value\": 8, \"min_length\": 9, \"max_length\": 9, \"matches\": \"matches\", \"position\": 8, \"group_by\": \"groupBy\", \"source\": \"source\"}, \"link\": \"link\"}], \"outputs\": [{\"name\": \"name\", \"value\": \"value\", \"use_default\": true, \"metadata\": {\"type\": \"boolean\", \"aliases\": [\"aliases\"], \"description\": \"description\", \"cloud_data_type\": \"cloudDataType\", \"default_value\": \"defaultValue\", \"link_status\": \"normal\", \"secure\": true, \"immutable\": false, \"hidden\": true, \"required\": true, \"options\": [\"options\"], \"min_value\": 8, \"max_value\": 8, \"min_length\": 9, \"max_length\": 9, \"matches\": \"matches\", \"position\": 8, \"group_by\": \"groupBy\", \"source\": \"source\"}, \"link\": \"link\"}], \"modules\": [{\"module_id\": \"moduleId\", \"module_type\": \"workspace\", \"name\": \"name\", \"layer\": \"layer\", \"source\": {\"source_type\": \"local\", \"git\": {\"computed_git_repo_url\": \"computedGitRepoUrl\", \"git_repo_url\": \"gitRepoUrl\", \"git_token\": \"gitToken\", \"git_repo_folder\": \"gitRepoFolder\", \"git_release\": \"gitRelease\", \"git_branch\": \"gitBranch\", \"git_commit\": \"gitCommit\", \"git_commit_timestamp\": \"gitCommitTimestamp\"}, \"catalog\": {\"catalog_name\": \"catalogName\", \"catalog_id\": \"catalogId\", \"offering_name\": \"offeringName\", \"offering_version\": \"offeringVersion\", \"offering_kind\": \"offeringKind\", \"offering_target_kind\": \"offeringTargetKind\", \"offering_id\": \"offeringId\", \"offering_version_id\": \"offeringVersionId\", \"offering_version_flavour_name\": \"offeringVersionFlavourName\", \"offering_repo_url\": \"offeringRepoUrl\", \"offering_provisioner_working_directory\": \"offeringProvisionerWorkingDirectory\", \"dry_run\": true, \"owning_account\": \"owningAccount\", \"item_icon_url\": \"itemIconUrl\", \"item_id\": \"itemId\", \"item_name\": \"itemName\", \"item_readme_url\": \"itemReadmeUrl\", \"item_url\": \"itemUrl\", \"launch_url\": \"launchUrl\"}}, \"injectors\": [{\"tft_git_url\": \"tftGitUrl\", \"tft_git_token\": \"tftGitToken\", \"tft_prefix\": \"tftPrefix\", \"injection_type\": \"injectionType\", \"tft_name\": \"tftName\", \"tft_parameters\": [{\"name\": \"name\", \"value\": \"value\"}]}], \"tags\": \"tags\", \"description\": \"description\", \"created_at\": \"2019-01-01T12:00:00.000Z\", \"created_by\": \"createdBy\", \"updated_at\": \"2019-01-01T12:00:00.000Z\", \"updated_by\": \"updatedBy\", \"version\": [\"version\"], \"status\": \"status\", \"location\": \"location\", \"inputs\": [{\"name\": \"name\", \"value\": \"value\", \"use_default\": true, \"metadata\": {\"type\": \"boolean\", \"aliases\": [\"aliases\"], \"description\": \"description\", \"cloud_data_type\": \"cloudDataType\", \"default_value\": \"defaultValue\", \"link_status\": \"normal\", \"secure\": true, \"immutable\": false, \"hidden\": true, \"required\": true, \"options\": [\"options\"], \"min_value\": 8, \"max_value\": 8, \"min_length\": 9, \"max_length\": 9, \"matches\": \"matches\", \"position\": 8, \"group_by\": \"groupBy\", \"source\": \"source\"}, \"link\": \"link\"}], \"settings\": [{\"name\": \"name\", \"value\": \"value\", \"use_default\": true, \"metadata\": {\"type\": \"boolean\", \"aliases\": [\"aliases\"], \"description\": \"description\", \"cloud_data_type\": \"cloudDataType\", \"default_value\": \"defaultValue\", \"link_status\": \"normal\", \"secure\": true, \"immutable\": false, \"hidden\": true, \"required\": true, \"options\": [\"options\"], \"min_value\": 8, \"max_value\": 8, \"min_length\": 9, \"max_length\": 9, \"matches\": \"matches\", \"position\": 8, \"group_by\": \"groupBy\", \"source\": \"source\"}, \"link\": \"link\"}], \"updated\": false, \"deleted\": false, \"outputs\": [{\"name\": \"name\", \"value\": \"value\", \"link\": \"link\"}], \"last_job\": {\"command_object\": \"workspace\", \"command_object_name\": \"commandObjectName\", \"command_object_id\": \"commandObjectId\", \"command_name\": \"workspace_plan\", \"job_status\": \"job_pending\"}}], \"flow\": {\"specs\": [{\"command_name\": \"workspace_plan\", \"flow_type\": \"sequence_flow\", \"sequence_flow\": [{\"sequence_number\": 14, \"item_name\": \"itemName\"}], \"conditional_flow\": \"conditionalFlow\"}]}, \"blueprint_id\": \"blueprintId\", \"crn\": \"crn\", \"account\": \"account\", \"created_at\": \"2019-01-01T12:00:00.000Z\", \"created_by\": \"createdBy\", \"updated_at\": \"2019-01-01T12:00:00.000Z\", \"updated_by\": \"updatedBy\", \"sys_lock\": {\"sys_locked\": false, \"sys_locked_by\": \"sysLockedBy\", \"sys_locked_at\": \"2019-01-01T12:00:00.000Z\"}, \"user_state\": {\"state\": \"draft\", \"set_by\": \"setBy\", \"set_at\": \"2019-01-01T12:00:00.000Z\"}, \"state\": {\"status_code\": \"Blueprint_Create_Init\", \"status_message\": \"statusMessage\", \"summary_status\": \"Blueprint_Normal\", \"config_status\": \"Blueprint_Config_Draft\", \"plan_status\": \"Blueprint_Plan_None\", \"run_status\": \"Blueprint_Run_Plan\", \"resource_status\": \"Blueprint_Resource_Drifted\"}}";
    String getBlueprintPath = "/v2/blueprints/testString";
    server.enqueue(new MockResponse()
      .setHeader("Content-type", "application/json")
      .setResponseCode(200)
      .setBody(mockResponseBody));
    ...
    // Invoke getBlueprint() with a valid options model and verify the result
    Response<Blueprint> response = schematicsService.getBlueprint(getBlueprintOptionsModel).execute();
    assertNotNull(response);
    Blueprint responseObj = response.getResult();
    assertNotNull(responseObj);
    ...
    // Verify request path
    String parsedPath = TestUtilities.parseReqPath(request);
    assertEquals(parsedPath, getBlueprintPath);
    // Verify query params
    Map<String, String> query = TestUtilities.parseQueryString(request);
    assertNotNull(query);
    assertEquals(query.get("profile"), "ids");
  ...
  // Test the getBlueprint operation with and without retries enabled
  @Test
  public void testGetBlueprintWRetries() throws Throwable {
    schematicsService.enableRetries(4, 30);
    testGetBlueprintWOptions();

    schematicsService.disableRetries();
    testGetBlueprintWOptions();
  }

  // Test the getBlueprint operation with a null options model (negative test)
  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testGetBlueprintNoOptions() throws Throwable {
    server.enqueue(new MockResponse());
    schematicsService.getBlueprint(null).execute();
  }

  // Test the replaceBlueprint operation with a valid options model parameter
  @Test
  public void testReplaceBlueprintWOptions() throws Throwable {
    // Register a mock response
    String mockResponseBody = "{\"name\": \"Toronto Dev Environtment\", \"schema_version\": \"1.0\", \"source\": {\"source_type\": \"local\", \"git\": {\"computed_git_repo_url\": \"computedGitRepoUrl\", \"git_repo_url\": \"gitRepoUrl\", \"git_token\": \"gitToken\", \"git_repo_folder\": \"gitRepoFolder\", \"git_release\": \"gitRelease\", \"git_branch\": \"gitBranch\", \"git_commit\": \"gitCommit\", \"git_commit_timestamp\": \"gitCommitTimestamp\"}, \"catalog\": {\"catalog_name\": \"catalogName\", \"catalog_id\": \"catalogId\", \"offering_name\": \"offeringName\", \"offering_version\": \"offeringVersion\", \"offering_kind\": \"offeringKind\", \"offering_target_kind\": \"offeringTargetKind\", \"offering_id\": \"offeringId\", \"offering_version_id\": \"offeringVersionId\", \"offering_version_flavour_name\": \"offeringVersionFlavourName\", \"offering_repo_url\": \"offeringRepoUrl\", \"offering_provisioner_working_directory\": \"offeringProvisionerWorkingDirectory\", \"dry_run\": true, \"owning_account\": \"owningAccount\", \"item_icon_url\": \"itemIconUrl\", \"item_id\": \"itemId\", \"item_name\": \"itemName\", \"item_readme_url\": \"itemReadmeUrl\", \"item_url\": \"itemUrl\", \"launch_url\": \"launchUrl\"}}, \"config\": [{\"name\": \"name\", \"description\": \"description\", \"source\": {\"source_type\": \"local\", \"git\": {\"computed_git_repo_url\": \"computedGitRepoUrl\", \"git_repo_url\": \"gitRepoUrl\", \"git_token\": \"gitToken\", \"git_repo_folder\": \"gitRepoFolder\", \"git_release\": \"gitRelease\", \"git_branch\": \"gitBranch\", \"git_commit\": \"gitCommit\", \"git_commit_timestamp\": \"gitCommitTimestamp\"}, \"catalog\": {\"catalog_name\": \"catalogName\", \"catalog_id\": \"catalogId\", \"offering_name\": \"offeringName\", \"offering_version\": \"offeringVersion\", \"offering_kind\": \"offeringKind\", \"offering_target_kind\": \"offeringTargetKind\", \"offering_id\": \"offeringId\", \"offering_version_id\": \"offeringVersionId\", \"offering_version_flavour_name\": \"offeringVersionFlavourName\", \"offering_repo_url\": \"offeringRepoUrl\", \"offering_provisioner_working_directory\": \"offeringProvisionerWorkingDirectory\", \"dry_run\": true, \"owning_account\": \"owningAccount\", \"item_icon_url\": \"itemIconUrl\", \"item_id\": \"itemId\", \"item_name\": \"itemName\", \"item_readme_url\": \"itemReadmeUrl\", \"item_url\": \"itemUrl\", \"launch_url\": \"launchUrl\"}}, \"inputs\": [{\"name\": \"name\", \"value\": \"value\", \"use_default\": true, \"metadata\": {\"type\": \"boolean\", \"aliases\": [\"aliases\"], \"description\": \"description\", \"cloud_data_type\": \"cloudDataType\", \"default_value\": \"defaultValue\", \"link_status\": \"normal\", \"secure\": true, \"immutable\": false, \"hidden\": true, \"required\": true, \"options\": [\"options\"], \"min_value\": 8, \"max_value\": 8, \"min_length\": 9, \"max_length\": 9, \"matches\": \"matches\", \"position\": 8, \"group_by\": \"groupBy\", \"source\": \"source\"}, \"link\": \"link\"}]}], \"description\": \"Deploys dev environtment instance in Toronto Region\", \"resource_group\": \"Default\", \"tags\": [\"tags\"], \"location\": \"us-south\", \"inputs\": [{\"name\": \"name\", \"value\": \"value\", \"use_default\": true, \"metadata\": {\"type\": \"boolean\", \"aliases\": [\"aliases\"], \"description\": \"description\", \"cloud_data_type\": \"cloudDataType\", \"default_value\": \"defaultValue\", \"link_status\": \"normal\", \"secure\": true, \"immutable\": false, \"hidden\": true, \"required\": true, \"options\": [\"options\"], \"min_value\": 8, \"max_value\": 8, \"min_length\": 9, \"max_length\": 9, \"matches\": \"matches\", \"position\": 8, \"group_by\": \"groupBy\", \"source\": \"source\"}, \"link\": \"link\"}], \"settings\": [{\"name\": \"name\", \"value\": \"value\", \"use_default\": true, \"metadata\": {\"type\": \"boolean\", \"aliases\": [\"aliases\"], \"description\": \"description\", \"cloud_data_type\": \"cloudDataType\", \"default_value\": \"defaultValue\", \"link_status\": \"normal\", \"secure\": true, \"immutable\": false, \"hidden\": true, \"required\": true, \"options\": [\"options\"], \"min_value\": 8, \"max_value\": 8, \"min_length\": 9, \"max_length\": 9, \"matches\": \"matches\", \"position\": 8, \"group_by\": \"groupBy\", \"source\": \"source\"}, \"link\": \"link\"}], \"outputs\": [{\"name\": \"name\", \"value\": \"value\", \"use_default\": true, \"metadata\": {\"type\": \"boolean\", \"aliases\": [\"aliases\"], \"description\": \"description\", \"cloud_data_type\": \"cloudDataType\", \"default_value\": \"defaultValue\", \"link_status\": \"normal\", \"secure\": true, \"immutable\": false, \"hidden\": true, \"required\": true, \"options\": [\"options\"], \"min_value\": 8, \"max_value\": 8, \"min_length\": 9, \"max_length\": 9, \"matches\": \"matches\", \"position\": 8, \"group_by\": \"groupBy\", \"source\": \"source\"}, \"link\": \"link\"}], \"modules\": [{\"module_id\": \"moduleId\", \"module_type\": \"workspace\", \"name\": \"name\", \"layer\": \"layer\", \"source\": {\"source_type\": \"local\", \"git\": {\"computed_git_repo_url\": \"computedGitRepoUrl\", \"git_repo_url\": \"gitRepoUrl\", \"git_token\": \"gitToken\", \"git_repo_folder\": \"gitRepoFolder\", \"git_release\": \"gitRelease\", \"git_branch\": \"gitBranch\", \"git_commit\": \"gitCommit\", \"git_commit_timestamp\": \"gitCommitTimestamp\"}, \"catalog\": {\"catalog_name\": \"catalogName\", \"catalog_id\": \"catalogId\", \"offering_name\": \"offeringName\", \"offering_version\": \"offeringVersion\", \"offering_kind\": \"offeringKind\", \"offering_target_kind\": \"offeringTargetKind\", \"offering_id\": \"offeringId\", \"offering_version_id\": \"offeringVersionId\", \"offering_version_flavour_name\": \"offeringVersionFlavourName\", \"offering_repo_url\": \"offeringRepoUrl\", \"offering_provisioner_working_directory\": \"offeringProvisionerWorkingDirectory\", \"dry_run\": true, \"owning_account\": \"owningAccount\", \"item_icon_url\": \"itemIconUrl\", \"item_id\": \"itemId\", \"item_name\": \"itemName\", \"item_readme_url\": \"itemReadmeUrl\", \"item_url\": \"itemUrl\", \"launch_url\": \"launchUrl\"}}, \"injectors\": [{\"tft_git_url\": \"tftGitUrl\", \"tft_git_token\": \"tftGitToken\", \"tft_prefix\": \"tftPrefix\", \"injection_type\": \"injectionType\", \"tft_name\": \"tftName\", \"tft_parameters\": [{\"name\": \"name\", \"value\": \"value\"}]}], \"tags\": \"tags\", \"description\": \"description\", \"created_at\": \"2019-01-01T12:00:00.000Z\", \"created_by\": \"createdBy\", \"updated_at\": \"2019-01-01T12:00:00.000Z\", \"updated_by\": \"updatedBy\", \"version\": [\"version\"], \"status\": \"status\", \"location\": \"location\", \"inputs\": [{\"name\": \"name\", \"value\": \"value\", \"use_default\": true, \"metadata\": {\"type\": \"boolean\", \"aliases\": [\"aliases\"], \"description\": \"description\", \"cloud_data_type\": \"cloudDataType\", \"default_value\": \"defaultValue\", \"link_status\": \"normal\", \"secure\": true, \"immutable\": false, \"hidden\": true, \"required\": true, \"options\": [\"options\"], \"min_value\": 8, \"max_value\": 8, \"min_length\": 9, \"max_length\": 9, \"matches\": \"matches\", \"position\": 8, \"group_by\": \"groupBy\", \"source\": \"source\"}, \"link\": \"link\"}], \"settings\": [{\"name\": \"name\", \"value\": \"value\", \"use_default\": true, \"metadata\": {\"type\": \"boolean\", \"aliases\": [\"aliases\"], \"description\": \"description\", \"cloud_data_type\": \"cloudDataType\", \"default_value\": \"defaultValue\", \"link_status\": \"normal\", \"secure\": true, \"immutable\": false, \"hidden\": true, \"required\": true, \"options\": [\"options\"], \"min_value\": 8, \"max_value\": 8, \"min_length\": 9, \"max_length\": 9, \"matches\": \"matches\", \"position\": 8, \"group_by\": \"groupBy\", \"source\": \"source\"}, \"link\": \"link\"}], \"updated\": false, \"deleted\": false, \"outputs\": [{\"name\": \"name\", \"value\": \"value\", \"link\": \"link\"}], \"last_job\": {\"command_object\": \"workspace\", \"command_object_name\": \"commandObjectName\", \"command_object_id\": \"commandObjectId\", \"command_name\": \"workspace_plan\", \"job_status\": \"job_pending\"}}], \"flow\": {\"specs\": [{\"command_name\": \"workspace_plan\", \"flow_type\": \"sequence_flow\", \"sequence_flow\": [{\"sequence_number\": 14, \"item_name\": \"itemName\"}], \"conditional_flow\": \"conditionalFlow\"}]}, \"blueprint_id\": \"blueprintId\", \"crn\": \"crn\", \"account\": \"account\", \"created_at\": \"2019-01-01T12:00:00.000Z\", \"created_by\": \"createdBy\", \"updated_at\": \"2019-01-01T12:00:00.000Z\", \"updated_by\": \"updatedBy\", \"sys_lock\": {\"sys_locked\": false, \"sys_locked_by\": \"sysLockedBy\", \"sys_locked_at\": \"2019-01-01T12:00:00.000Z\"}, \"user_state\": {\"state\": \"draft\", \"set_by\": \"setBy\", \"set_at\": \"2019-01-01T12:00:00.000Z\"}, \"state\": {\"status_code\": \"Blueprint_Create_Init\", \"status_message\": \"statusMessage\", \"summary_status\": \"Blueprint_Normal\", \"config_status\": \"Blueprint_Config_Draft\", \"plan_status\": \"Blueprint_Plan_None\", \"run_status\": \"Blueprint_Run_Plan\", \"resource_status\": \"Blueprint_Resource_Drifted\"}}";
    String replaceBlueprintPath = "/v2/blueprints/testString";
    server.enqueue(new MockResponse()
      .setHeader("Content-type", "application/json")
      .setResponseCode(200)
      .setBody(mockResponseBody));
    ...
    // Invoke replaceBlueprint() with a valid options model and verify the result
    Response<Blueprint> response = schematicsService.replaceBlueprint(replaceBlueprintOptionsModel).execute();
    assertNotNull(response);
    Blueprint responseObj = response.getResult();
    assertNotNull(responseObj);
    ...
    // Verify request path
    String parsedPath = TestUtilities.parseReqPath(request);
    assertEquals(parsedPath, replaceBlueprintPath);
    // Verify query params
    Map<String, String> query = TestUtilities.parseQueryString(request);
    assertNotNull(query);
    assertEquals(query.get("profile"), "ids");
  ...
  // Test the replaceBlueprint operation with and without retries enabled
  @Test
  public void testReplaceBlueprintWRetries() throws Throwable {
    schematicsService.enableRetries(4, 30);
    testReplaceBlueprintWOptions();

    schematicsService.disableRetries();
    testReplaceBlueprintWOptions();
  }

  // Test the replaceBlueprint operation with a null options model (negative test)
  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testReplaceBlueprintNoOptions() throws Throwable {
    server.enqueue(new MockResponse());
    schematicsService.replaceBlueprint(null).execute();
  }

  // Test the deleteBlueprint operation with a valid options model parameter
  @Test
  public void testDeleteBlueprintWOptions() throws Throwable {
    // Register a mock response
    String mockResponseBody = "";
    String deleteBlueprintPath = "/v2/blueprints/testString";
    server.enqueue(new MockResponse()
      .setResponseCode(204)
      .setBody(mockResponseBody));

    // Construct an instance of the DeleteBlueprintOptions model
    DeleteBlueprintOptions deleteBlueprintOptionsModel = new DeleteBlueprintOptions.Builder()
      .blueprintId("testString")
      .profile("ids")
      .destroy(true)
      .build();

    // Invoke deleteBlueprint() with a valid options model and verify the result
    Response<Void> response = schematicsService.deleteBlueprint(deleteBlueprintOptionsModel).execute();
    assertNotNull(response);
    Void responseObj = response.getResult();
    assertNull(responseObj);
    ...
    // Verify request path
    String parsedPath = TestUtilities.parseReqPath(request);
    assertEquals(parsedPath, deleteBlueprintPath);
    // Verify query params
    Map<String, String> query = TestUtilities.parseQueryString(request);
    assertNotNull(query);
    assertEquals(query.get("profile"), "ids");
  ...
  // Test the deleteBlueprint operation with and without retries enabled
  @Test
  public void testDeleteBlueprintWRetries() throws Throwable {
    schematicsService.enableRetries(4, 30);
    testDeleteBlueprintWOptions();

    schematicsService.disableRetries();
    testDeleteBlueprintWOptions();
  }

  // Test the deleteBlueprint operation with a null options model (negative test)
  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testDeleteBlueprintNoOptions() throws Throwable {
    server.enqueue(new MockResponse());
    schematicsService.deleteBlueprint(null).execute();
  }

  // Test the uploadTemplateTarBlueprint operation with a valid options model parameter
  @Test
  public void testUploadTemplateTarBlueprintWOptions() throws Throwable {
    // Register a mock response
    String mockResponseBody = "{\"file_value\": \"fileValue\", \"has_received_file\": false}";
    String uploadTemplateTarBlueprintPath = "/v2/blueprints/testString/template_repo_upload";
    server.enqueue(new MockResponse()
      .setHeader("Content-type", "application/json")
      .setResponseCode(200)
      .setBody(mockResponseBody));
    ...
    // Invoke uploadTemplateTarBlueprint() with a valid options model and verify the result
    Response<BlueprintTemplateRepoTarUploadResponse> response = schematicsService.uploadTemplateTarBlueprint(uploadTemplateTarBlueprintOptionsModel).execute();
    assertNotNull(response);
    BlueprintTemplateRepoTarUploadResponse responseObj = response.getResult();
    assertNotNull(responseObj);
    ...
    // Verify request path
    String parsedPath = TestUtilities.parseReqPath(request);
    assertEquals(parsedPath, uploadTemplateTarBlueprintPath);
    // Verify that there is no query string
    Map<String, String> query = TestUtilities.parseQueryString(request);
    assertNull(query);
  }

  // Test the uploadTemplateTarBlueprint operation with and without retries enabled
  @Test
  public void testUploadTemplateTarBlueprintWRetries() throws Throwable {
    schematicsService.enableRetries(4, 30);
    testUploadTemplateTarBlueprintWOptions();

    schematicsService.disableRetries();
    testUploadTemplateTarBlueprintWOptions();
  }

  // Test the uploadTemplateTarBlueprint operation with a null options model (negative test)
  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testUploadTemplateTarBlueprintNoOptions() throws Throwable {
    server.enqueue(new MockResponse());
    schematicsService.uploadTemplateTarBlueprint(null).execute();
  }
