...
public class UpdateInventoryOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(UpdateInventoryOptions updateInventoryOptions) {
      ...
      this.name = updateInventoryOptions.name;
      this.description = updateInventoryOptions.description;
      this.location = updateInventoryOptions.location;
      this.resourceGroup = updateInventoryOptions.resourceGroup;
      this.inventoriesIni = updateInventoryOptions.inventoriesIni;
      this.resourceQueries = updateInventoryOptions.resourceQueries;
    }
