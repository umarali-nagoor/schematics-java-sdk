...
/**
 * The replaceKmsSettings options.
 */
public class ReplaceKmsSettingsOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(ReplaceKmsSettingsOptions replaceKmsSettingsOptions) {
      this.location = replaceKmsSettingsOptions.location;
      this.encryptionScheme = replaceKmsSettingsOptions.encryptionScheme;
      this.resourceGroup = replaceKmsSettingsOptions.resourceGroup;
      this.primaryCrk = replaceKmsSettingsOptions.primaryCrk;
      this.secondaryCrk = replaceKmsSettingsOptions.secondaryCrk;
    }
    ...
    /**
     * Builds a ReplaceKmsSettingsOptions.
     *
     * @return the new ReplaceKmsSettingsOptions instance
     */
    public ReplaceKmsSettingsOptions build() {
      return new ReplaceKmsSettingsOptions(this);
    }
     ...
     * @return the ReplaceKmsSettingsOptions builder
     */
  ...
  protected ReplaceKmsSettingsOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a ReplaceKmsSettingsOptions builder
   */
